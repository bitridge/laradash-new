...
<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            @can('create', SeoLog::class)
            <a href="{{ route('seo-logs.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                {{ __('Create New Log') }}
            </a>
            @endcan
        </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        @can('view', $log)
                                        <a href="{{ route('seo-logs.show', $log) }}" class="text-blue-600 hover:text-blue-900 mr-3">
                                            {{ __('View') }}
                                        </a>
                                        @endcan
                                        @can('update', $log)
                                        <a href="{{ route('seo-logs.edit', $log) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                            {{ __('Edit') }}
                                        </a>
                                        @endcan
                                        @can('delete', $log)
